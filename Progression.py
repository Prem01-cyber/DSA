class Progression:
    ...
    def _advance(self):
        ...
        _current    the most recent value generated by the progression
        _prev       the value (if any) that was returned upon the most recent call to next
        """
        self._current += 1
...
class FibonacciProgression(Progression):
    ...
    Default start values are 0 and 1.
    """
